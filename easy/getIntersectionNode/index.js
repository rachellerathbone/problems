...
//     if the two lists intersect). From the head of A, it reads as [4,1,8,4,5]. From
...
//     the two lists intersect). From the head of A, it reads as [1,9,1,2,4]. From the head
...
const getIntersectionNode = function(headA, headB) {
    let listALen = getListLength(headA)
    let listBLen = getListLength(headB)

    let currA = headA
    let currB = headB

    for (let i = 0; i < Math.abs(listALen - listBLen); i++) {
